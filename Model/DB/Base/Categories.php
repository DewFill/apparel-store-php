...
abstract class Categories implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\CategoriesTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\Categories object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoriesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\Categories'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\Categories (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\Categories Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setProductCategoriess(Collection $productCategoriess, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($productCategoriessToDelete as $productCategoriesRemoved) {
            $productCategoriesRemoved->setCategories(null);
        }
    ...
    protected function doAddProductCategories(ChildProductCategories $productCategories): void
    {
        ...
        $productCategories->setCategories($this);
    }
    ...
    public function removeProductCategories(ChildProductCategories $productCategories)
    {
        if ($this->getProductCategoriess()->contains($productCategories)) {
            ...
            $productCategories->setCategories(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildProductCategories}> List of ChildProductCategories objects
     */
    public function getProductCategoriessJoinProducts(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductCategoriesQuery::create(null, $criteria);
