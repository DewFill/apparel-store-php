...
abstract class Brands implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\BrandsTableMap';
    ...
    /**
     * Initializes internal state of DB\Base\Brands object.
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BrandsTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BrandsTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BrandsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BrandsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = BrandsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DB\\Brands'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(BrandsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BrandsTableMap::COL_NAME)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(BrandsTableMap::COL_ID)) {
            $criteria->add(BrandsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BrandsTableMap::COL_NAME)) {
            $criteria->add(BrandsTableMap::COL_NAME, $this->name);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\Brands (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\Brands Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initProductss(bool $overrideExisting = true): void
    {
        ...
        $this->collProductss->setModel('\DB\Products');
    }
        ...
        if (null === $this->collProductss || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProductss) {
                    ...
                    $collProductss->setModel('\DB\Products');
