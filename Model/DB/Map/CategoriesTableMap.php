...
class CategoriesTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'DB.Map.CategoriesTableMap';
     ...
     */
    public const OM_CLASS = '\\DB\\Categories';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'DB.Categories';
     ...
     */
    public const COL_NAME = 'categories.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [CategoriesTableMap::COL_ID, CategoriesTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [CategoriesTableMap::COL_ID => 0, CategoriesTableMap::COL_NAME => 1, ],
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\DB\\Categories');
        $this->setPackage('DB');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to categories     * by a foreign key with ON DELETE CASCADE
     */
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Categories) { // it's a model object
