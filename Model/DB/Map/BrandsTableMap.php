...
class BrandsTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'DB.Map.BrandsTableMap';
     ...
     */
    public const OM_CLASS = '\\DB\\Brands';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'DB.Brands';
     ...
     */
    public const COL_ID = 'brands.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'brands.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [BrandsTableMap::COL_ID, BrandsTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [BrandsTableMap::COL_ID => 0, BrandsTableMap::COL_NAME => 1, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'brands.id' => 'ID',
        'BrandsTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Brands.Name' => 'NAME',
        'name' => 'NAME',
        'brands.name' => 'NAME',
        'BrandsTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ];
    ...
    {
        $this->addRelation('Products', '\\DB\\Products', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':brand_id',
    1 => ':id',
  ),
), 'SET NULL', 'CASCADE', 'Productss', false);
    }

    /**
     * Method to invalidate the instance pool of all tables related to brands     * by a foreign key with ON DELETE CASCADE
     */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BrandsTableMap::COL_ID);
            $criteria->addSelectColumn(BrandsTableMap::COL_NAME);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BrandsTableMap::COL_ID);
            $criteria->removeSelectColumn(BrandsTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Brands) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(BrandsTableMap::DATABASE_NAME);
            $criteria->add(BrandsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(BrandsTableMap::COL_ID) && $criteria->keyContainsValue(BrandsTableMap::COL_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.BrandsTableMap::COL_ID.')');
        }
